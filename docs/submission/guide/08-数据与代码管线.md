...
> **函数级 walkthrough、答辩口述稿与真实源码摘录** → [10 答辩代码讲解](./10-答辩代码讲解.md) · 子章 [10a](./10a-体渲染与VTK代码.md)–[10e](./10e-Python配图代码.md)
...
[← 08 数据与代码管线](./08-数据与代码管线.md) · [下一章：09 复现与答辩 →](./09-本地复现与答辩清单.md)
